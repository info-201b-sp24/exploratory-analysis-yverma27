...
[Summary Info](exploratory-analysis-yverma27/index_files/summaryinfo.R)
...
Our third chart shows the frequency of each of the different genres within our data table. We chose this chart because we wanted to know which genres are most popular on Netflix. With this information, we can make predictions about which genres may have been watched more during Covid, when more people were at home utlitzing streaming platforms. Through this graph, we can see that shows and movies of short, sci-fi, mystery, and family genres are most popular. Alternatively, the least common genres are shows and movies of combined comedy and drama genres, documentaries, and adventure animation. This shows that in general, shorter, sci-fi, mystery, and family-related Netflix content is much more popoular than comedy dramas, documentaries, and animated adventure shows and movies.
